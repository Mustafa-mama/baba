...
@section('title', 'add-vendore')
@section('cearte_vendore')
 <div class="container">
    <div class="card-body lang">
    @include('admin.includes.alerts.success') 
    @include('admin.includes.alerts.errors')
        
  <form class="form" action="{{route('store.vendore.admin')}}"
   method="Post" enctype="multipart/form-data">
       @csrf
  

   
     <h1 class="form-section text-center"><i class="ft-home"></i> اضافة متجر</h1>
